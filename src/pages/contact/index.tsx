    ...
    return (
        <section className=" w-full h-screen text-white overflow-hidden fixed z-[20]">
            ...
            <div className="flex  w-full justify-center px-[55px] py-8 border-y border-y-[#9D9D9D] h-[30%] bg-[rgba(108,108,108,0.1)] backdrop-blur-lg text-[24px]">
                <div className="flex flex-col justify-between w-1/3 border-r border-r-[#9D9D9D] px-5">
                ...
                <div className="flex flex-col justify-between w-1/3 px-5  border-r border-r-[#9D9D9D]">
                    <div className="flex flex-col gap-2">
                        <p className="text-[12px]">②</p>
                        <p>이메일</p>
                    </div>
                ...
                <div className="flex flex-col justify-between w-1/3 px-5">
                    <div className="flex flex-col gap-2">
                        <p className="text-[12px]">③</p>
                        <p>SNS</p>
                    </div>
